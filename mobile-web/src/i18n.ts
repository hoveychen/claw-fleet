...
const DICT: Record<string, string> = {
  ...
  // ── Fleet Cloud (cloud/CloudApp.tsx) ──
  "Cloud 在线": "Cloud online",
  "同步中": "Syncing",
  "连接失败": "Connection failed",
  "未命名任务": "Untitled task",
  "Agent 正在等待你的决定": "The agent is waiting for your decision",
  "托管工作区": "Hosted workspace",
  "云任务": "Cloud tasks",
  "待处理决策": "Pending decisions",
  "正在读取控制面…": "Loading the control plane…",
  "还没有云任务": "No cloud tasks yet",
  "通过公开 Task API 创建的工作会出现在这里。": "Work created through the public Task API shows up here.",
  "Agent 请求人工输入时，会连同所属 Attempt 出现在这里。": "When an agent asks for human input, it shows up here with its attempt.",
  "读取任务": "Loading task",
  "正在同步任务事件…": "Syncing task events…",
  "{0} 次尝试": "{0} attempts",
  "会话记录": "Transcript",
  "还没有会话消息。": "No messages yet.",
  "尝试链": "Attempts",
  "等待 Runner 接单": "Waiting for a runner",
  "输入答复": "Type a reply",
  "决策答复": "Decision reply",
  "提交中…": "Submitting…",
  "提交答复": "Submit reply",
