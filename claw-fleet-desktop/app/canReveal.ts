 ...
 * button), and Artifacts' detail bar. Some of them had grown the check and some
 * had not.
 *
 * The Artifacts page is also why this must stay a *synchronous* predicate: its two OS
