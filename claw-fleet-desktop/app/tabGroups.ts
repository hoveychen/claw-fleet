 ...
 *
 * Deliberately not `openTabInActiveGroup`: that lands the copy in the very group
 * the conversation is in — the one place it is useless. "Beside" here means the
 * group after the one holding the conversation, which is what the user pointed
