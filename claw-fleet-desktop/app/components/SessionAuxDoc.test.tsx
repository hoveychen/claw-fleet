...
// The four readers are the real 仓库 (Files) / 知识库 (Wiki) / 产出 (Outputs) panes; they
...
describe("SessionAuxDoc", () => {
  ...
  it("gives a deliverable the 产出 (Outputs) reader, addressed by store id", () => {
  ...
  // (关闭其他 / 全部关闭) silently did nothing.
