...
import type { HandoffChain, RateLimitState, SessionInfo, SessionStatus } from "../types";
...
function HandoffChainRow({ session }: { session: SessionInfo }) {
  const { t } = useTranslation();
  const sessions = useSessionsStore((s) => s.sessions);
