...
impl Backend for NullBackend {
    ...
    fn set_session_mark(
        ...
        _: String,
        _: String,
        _: Option<claw_fleet_core::session_mark::SessionMark>,
    ) -> Result<(), String> {
        Err("backend not ready".into())
    }
    ...
    fn read_review_doc(
        &self,
        _: &claw_fleet_core::mcp_ipc::ReviewDoc,
    ...
    fn delete_wiki_folder(&self, _: &str) -> Result<usize, String> {
        Err("backend not ready".into())
    }
    ...
    fn apply_model_guidance(&self, _: &str) -> Result<(), String> {
        Err("backend not ready".into())
    }
    ...
    fn list_task_reviews(&self, _: &str) -> Vec<claw_fleet_core::task_review::TaskReview> {
        Vec::new()
    }
