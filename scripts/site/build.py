...
<p id="demo" class="field-guide wrap"><a class="text-link" href="{base}player/index.html">{'观看完整产品导览（英文）' if lang=='zh' else 'Watch the full product field guide'} <span aria-hidden="true">↗</span></a></p>
